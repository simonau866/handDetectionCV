...
void waitForPalmCover(MyImage* m) 
{
	...
	roi.push_back(My_ROI(Point(m->src.cols / 2 - 20, m->src.rows / 2 - 20), Point(m->src.cols / 2 - 20 + square_len, m->src.rows / 2 - 20 + square_len), m->src));
	roi.push_back(My_ROI(Point(m->src.cols / 2 - 20, m->src.rows / 2 + 20), Point(m->src.cols / 2 - 20 + square_len, m->src.rows / 2 + 20 + square_len), m->src));
	roi.push_back(My_ROI(Point(m->src.cols / 2 + 20, m->src.rows / 2 - 20), Point(m->src.cols / 2 + 20 + square_len, m->src.rows / 2 - 20 + square_len), m->src));
	roi.push_back(My_ROI(Point(m->src.cols / 2 + 20, m->src.rows / 2 + 20), Point(m->src.cols / 2 + 20 + square_len, m->src.rows / 2 + 20 + square_len), m->src));
	roi.push_back(My_ROI(Point(m->src.cols / 2, m->src.rows / 2 - 40), Point(m->src.cols / 2 + square_len, m->src.rows / 2 - 40 + square_len), m->src));
	roi.push_back(My_ROI(Point(m->src.cols / 2, m->src.rows / 2 + 40), Point(m->src.cols / 2 + square_len, m->src.rows / 2 + 40 + square_len), m->src));
